...
class Mat {
  ...
  detect() {
    if (
      ball.mesh.position.x >= this.mesh.position.x - 100.8 &&
      ball.mesh.position.x <= this.mesh.position.x + 100.8 &&
      ball.mesh.position.z >= this.mesh.position.z - 100.8 &&
      ball.mesh.position.z <= this.mesh.position.z + 100.8 &&
...
class Highobstacle {
  ...
  detect() {
    if (
      ball.mesh.position.x >= this.mesh.position.x - 0.0 &&
      ball.mesh.position.x <= this.mesh.position.x + 0.0 &&
      ball.mesh.position.z >= this.mesh.position.z - 0.0 &&
      ball.mesh.position.z <= this.mesh.position.z + 0.0 &&
      ball.mesh.position.z <= 0.0 &&
      ball.mesh.position.y < this.mesh.position.y + 0
    ) return true;
  }
}
